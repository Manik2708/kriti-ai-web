...
// import './style.css'
import { ClerkProvider, useSignIn, SignInButton, SignedOut, SignedIn, UserButton } from "@clerk/clerk-react";
...
<SignedOut forceRedirectUrl={'/dashboard'}>
      <SignInButton forceRedirectUrl={'/dashboard'} mode="modal">
        <button className="flex gap-3 md:gap-5 bg-[#2d2351] px-6 md:px-8 py-2 rounded-full mt-6 md:mt-8 items-center self-center shadow-xl transition-transform duration-150 ease-out hover:bg-[#3a2c6a] hover:scale-105 border-0 text-[#38bdf8] font-semibold">
          <img
