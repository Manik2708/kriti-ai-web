...
import {RedirectToSignIn, SignedIn, UserButton, useAuth } from '@clerk/clerk-react';
...
const navigate = useNavigate();
  ...
  const sites = [
    { name: 'Site1', url: 'www.site1.com', lastEdited: '22/01/2025' },
    { name: 'Site2', url: 'www.site2.com', lastEdited: '15/07/1947' },
    {name: 'Site3', url : '', lastEdited: '20/02/2002'}
  ];
  ...
  return (
    <div className="bg-gradient-to-br from-[#171124] to-[#1c142b] text-text-color min-h-screen overflow-x-hidden relative pb-16 sm:pb-0">
    {/* Navigation */}
    <nav className="fixed top-0 left-0 w-full h-16 md:h-20 flex justify-center items-center bg-gradient-to-br from-[#171124] to-[#1c142b] border-b border-gray-500/60 z-50">
      <div className="w-full flex justify-between items-center px-4">
        ...
        <div className="flex items-center">
          <h1 className="text-2xl md:text-3xl font-bold text-text-color">KamengWeb</h1>
          <h1 className="text-2xl md:text-3xl font-bold text-text-color-2">Pro</h1>
        </div>
        {/* Navigation Items */}
    ...
    {/* Dashboard Section */}
    <div className="flex w-full pt-24 md:pt-28 pb-6 sm:pb-0 px-4 pl-8">
    ...
    {/* Sites List */}
    <div className="flex w-full bg-gradient-to-br from-[#171124] to-[#1c142b] mt-8 px-4">
      <div className="w-full flex flex-col space-y-5">
        {sites.map((site, index) => (
          <WebsiteDetails key={index} name={site.name} lastEdited={site.lastEdited} url={site.url} />
        ))}
      </div>
    </div>
